...
def main():
    page = Path(os.environ.get('PANE_PAGE', str(ROOT / 'pane.html')))
    if not page.exists():
        raise SystemExit('pane.html missing; run tests/pane/build.py first')
